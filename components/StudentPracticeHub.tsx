...
const StudentPracticeHub: React.FC<StudentPracticeHubProps> = ({ userId, tenantId, wolfieConfig }) => {
    return (
        <div className="space-y-8 animate-fade-in-up pb-20 font-sans">
            ...
            {/* Cabeçalho da seção */}
            <div className="relative rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-violet-700 via-purple-700 to-indigo-700 shadow-2xl shadow-violet-500/20 text-white p-8 md:p-10">
                {/* Efeitos de fundo */}
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
                    ...
                    {/* Stat pill */}
                    <div className="md:ml-auto flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl shrink-0">
