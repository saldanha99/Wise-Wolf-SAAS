                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                            <button
                                ...
                                className="w-full py-4 bg-emerald-500 hover:bg-emerald-600 disabled:bg-slate-300 disabled:cursor-not-allowed text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2"
                            >
                                {loadingSubscription ? 'Processando...' : formData.subscription_id ? 'Assinatura Já Ativa' : 'Ativar Assinatura Automática'}
                            </button>
                            <p className="text-center text-[10px] text-slate-400 mt-2 font-bold uppercase tracking-wide">
                                Ao ativar, o aluno será cadastrado no Asaas se ainda não for.
                            </p>
                            {formData.planDuration !== 'RECURRENT' && (
                                <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800 rounded-xl text-center">
                                    <p className="text-xs font-bold text-blue-800 dark:text-blue-300">
                                        Resumo: O aluno receberá {formData.planDuration === 'SEMESTER' ? '6' : '12'} cobranças mensais de R$ {formData.monthly_fee || '...'}
                                    </p>
                                </div>
                            )}
                        </div>
