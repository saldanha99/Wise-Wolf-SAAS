...
export default function GoogleMeetSettings({ tenantId }: { tenantId?: string }) {
  ...
  return <div className="max-w-4xl space-y-5 p-4 sm:p-6">
    ...
    {status&&<>
      ...
      <p className="rounded-xl bg-amber-50 p-4 text-sm text-amber-900">Esta integração é destinada à documentação e continuidade pedagógica. A coleta de presença, atraso e avaliação de desempenho docente pelo Meet está desativada e não altera a folha de pagamento.</p>
