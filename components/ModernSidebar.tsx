...
const ModernSidebar: React.FC<ModernSidebarProps> = ({
    ...
    const commercialMenu: MenuItem[] = [
        ...
        { id: 'trials', label: 'Disparar Vaga', icon: Zap },
        { id: 'marketing', label: 'Links de Matrícula', icon: Globe },
        { id: 'automation', label: 'Smart WhatsApp', icon: Zap },
    ];
    ...
    const getMenuItems = () => {
        ...
        if (user.role === UserRole.COMMERCIAL) return commercialMenu;
