        ...
        <div className="relative z-10 flex flex-col items-end gap-3">
          ...
          {pending.length > 1 && (
            <button
              ...
              className="flex items-center gap-2 bg-tenant-primary text-white px-4 py-2 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-tenant-primary dark:hover:bg-tenant-primary dark:hover:text-white transition-all shadow-lg"
            >
          ...
          {pending.map((lesson) => (
            <div key={lesson.id} className="group bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 hover:border-tenant-primary dark:hover:border-tenant-primary/50 hover:shadow-xl hover:shadow-tenant-primary/10 transition-all flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
              ...
              <button
                ...
                className="w-full md:w-auto flex items-center justify-center gap-3 bg-tenant-primary text-white px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:scale-105 hover:bg-tenant-primary dark:hover:bg-tenant-primary dark:hover:text-white transition-all shadow-lg active:scale-95 group/btn"
              >
