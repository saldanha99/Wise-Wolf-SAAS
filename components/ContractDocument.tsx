    ...
    return (
        <div className="flex flex-col items-center gap-6 p-8 bg-gray-100 min-h-screen">
            ...
            >
                ...
                <p className="mb-4 text-justify">
                    O contrato terá vigência de <strong>{planDuration} meses</strong>, iniciando em {startDate} e terminando em {endDate}. O CONTRATANTE concorda com a renovação automática salvo manifestação em contrário.
                </p>

                <h3 className="font-bold mb-2 uppercase text-[#002366]">Cláusula 3 - Valor e Pagamento</h3>
                <p className="mb-4 text-justify">
                    O valor da mensalidade é de <strong>R$ {planValue}</strong>, referente ao {planName}. A cobrança será efetuada preferencialmente no dia <strong>{dueDay}</strong> de cada mês.
                </p>
