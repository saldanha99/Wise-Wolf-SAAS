                ...
                if (turbo) {
                    ...
                    if (suspended) {
                        ...
                        found.push({
                            ...
                            text: comFaixas(`O Turbo destrava a partir de ${Number(turbo.students_required ?? 7)} alunos na carteira — hoje você tem ${Number(turbo.students_active || 0)} — e 30 dias consecutivos sem falta.`),
                        });
