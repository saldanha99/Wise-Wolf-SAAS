...
import { CheckCircle, XCircle, FileText, Image, ExternalLink, Search, Loader2, AlertCircle, Eye, X } from 'lucide-react';
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-6xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                            <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                <div className="flex-1 bg-white p-4 shadow-sm rounded-xl border border-gray-200 min-h-[500px] overflow-auto scale-90 origin-top">
                                    <h4 className="font-bold text-gray-400 mb-4 uppercase text-xs tracking-wider">Visualização do Contrato</h4>
                                    <div className="pointer-events-none select-none">
                                        {/* We render contract but simplified or full */}
                                        <ContractDocument
                                            ...
                                            planDuration={12}
                                            startDate={new Date(selectedStudent.accepted_at).toLocaleDateString()}
                                            endDate={new Date(new Date(selectedStudent.accepted_at).setFullYear(new Date(selectedStudent.accepted_at).getFullYear() + 1)).toLocaleDateString()}
                                            dueDay={selectedStudent.due_day || 10}
                                            classFrequency={2} // Fetch this correctly in future
