    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-brand-surface p-4 rounded-3xl border border-brand-border shadow-sm flex items-center gap-4 group hover:border-tenant-primary transition-all">
                ...
                <div className="flex-1">
                    <div className="flex justify-between items-end mb-1">
                        <p className="text-[10px] font-black text-brand-muted uppercase tracking-widest">Nível Atual</p>
                        <p className="text-xs font-black text-tenant-primary">LEVEL {level}</p>
                    </div>
                    <div className="w-full bg-brand-surface-2 dark:bg-brand-surface-2 h-2 rounded-full overflow-hidden">
                        <div
            ...
            <div className="bg-brand-surface p-4 rounded-3xl border border-brand-border shadow-sm flex items-center gap-4 group hover:border-amber-500 transition-all">
                ...
                <div>
                    <p className="text-[10px] font-black text-brand-muted uppercase tracking-widest">Experiência</p>
                    <div className="flex items-baseline gap-1">
                        <span className="text-xl font-black text-brand-text">{xp}</span>
                        <span className="text-[10px] font-bold text-brand-muted">XP Total</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-brand-surface p-4 rounded-3xl border border-brand-border shadow-sm flex items-center gap-4 group hover:border-orange-600 transition-all">
                ...
                <div>
                    <p className="text-[10px] font-black text-brand-muted uppercase tracking-widest">Ofensiva</p>
                    <div className="flex items-baseline gap-1">
                        <span className="text-xl font-black text-brand-text">{streak}</span>
                        <span className="text-[10px] font-bold text-brand-muted uppercase tracking-tight">Dias Seguidos</span>
                    </div>
                </div>
            </div>
        </div>
