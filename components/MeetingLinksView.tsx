        ...
        <div className="space-y-8 animate-in fade-in duration-700">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="flex-1 py-3 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl font-bold text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-3 bg-slate-50 dark:bg-slate-800 text-slate-400 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-tenant-primary transition-all flex items-center gap-2"
            ...
            {editingStudent && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] shadow-2xl p-8 border border-white/10 relative">
                        <h3 className="text-lg font-black text-slate-800 dark:text-white mb-2">Editar Sala de Aula</h3>
                        <p className="text-sm text-slate-500 mb-6">Defina o link permanente para <strong>{editingStudent.full_name}</strong>.</p>

                        <div className="space-y-4">
                            <div>
                                <label className="text-[10px] uppercase font-black tracking-widest text-slate-400 ml-2">Link da Reunião (Meet/Zoom)</label>
                                <input
                                    className="w-full p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl outline-none font-bold text-sm focus:ring-2 focus:ring-tenant-primary"
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    ...
                                    className="flex-1 py-4 rounded-xl font-bold text-xs uppercase tracking-widest text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                                >
                                    Cancelar
                                </button>
                                <button
