                ...
                {plans.map((plan, index) => (
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="mt-6 flex items-center justify-center gap-x-2">
                                <span className="text-5xl font-bold tracking-tight text-foreground">
                                    <NumberFlow
                                        ...
                                        format={{
                                            style: "currency",
                                            currency: "BRL", // Adapted to BRL since this is a BR SaaS (Wise Wolf)
                                            minimumFractionDigits: 0,
                                            maximumFractionDigits: 0,
                                        }}
                                        formatter={(value) => `${value}`} // Removed $ prefix as currency format handles it? Or manually add R$. NumberFlow usually handles currency symbol if style is currency.
                                        transformTiming={{
                                            duration: 500,
                                            easing: "ease-out",
                                        }}
                            ...
                            <a // Changed from Link to a for safety
                                href={plan.href}
                                className={cn(
                                    buttonVariants({
                                        variant: "outline",
