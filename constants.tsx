...
// Colunas "seguras" de profiles (todas EXCETO hourly_rate, pix_key, commission_rate).
// Use no lugar de select('*') em profiles — o trio financeiro é lido via RPC
// (get_my_pay / get_tenant_teacher_pay) por quem tem direito. String copiada
// verbatim do information_schema (sem risco de typo). Ver claudedocs/FASE2-RLS-PROFILE-PRIVATE.md
export const PROFILE_SAFE_COLS = 'id, email, full_name, role, tenant_id, avatar_url, module, occupancy, created_at, phone, study_days, occupation, interests, meeting_link, monthly_fee, whatsapp_instance, status, xp, level, streak_count, last_activity, current_book_part, evaluation_unlocked, whatsapp_instance_id, current_topic_id, unlocked_tests, bank_name, agency, account_number, private_notes, fixed_schedule, pix_key_type, asaas_customer_id, cpf, address, address_number, postal_code, due_day, subscription_id, status_financial, lifecycle_status, contract_accepted, accepted_at, class_frequency, signature_ip, signature_url, contract_url, student_signature_url, signed_document_url, wise_wolf_signature_token, documentation_status, audit_status, validated_by, validation_date, rejection_reason, typed_signature, signature_hash, whatsapp_instance_name, whatsapp_status, contract_sent_at, welcome_sent_at, wa_welcome_sent, welcome_wa_sent, teachers_group_id, directors_group_id, rg, birth_date, monthly_tuition, fidelity_plan, date_automation_enabled, professor_id, wolfie_settings, referrer_teacher_id, guardian_name, guardian_cpf, guardian_email, hr_group_id, referrer_student_id, enrollment_fee, enrollment_fee_paid, enrollment_payment_id, start_date, user_ip, gamification_consent_by_guardian, guardian_id, league_opt_in, league_display_name, notification_preference, professor_id2, specializations, english_for, student_category, learning_objective, personality, preferred_topics, avoided_topics, short_term_goal, long_term_goal, lesson_reminder_template, suspended_at, suspended_reason, first_overdue_at, offboarding_status, offboarding_requested_at, offboarding_reason, offboarding_last_day, offboarding_completed_at, hearts, hearts_updated_at, last_streak_date, daily_xp, daily_xp_date, daily_xp_goal, hearts_full_notified, onboarded, guardian_phone, attendance_phone, is_kids, is_test_account, is_trainer';
