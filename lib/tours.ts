    ...
    steps: [
      {
        ...
        text: 'Este tour mostra onde fica cada coisa. Leva menos de dois minutos, dá para sair quando quiser e rever depois em "Tour guiado", no menu do seu avatar (canto superior direito).',
      },
      {
        target: 'sidebar-nav',
        view: 'dashboard',
        title: 'Seu menu',
        text: 'Organizado pelo que você faz: Dia a dia (Início, Mapa de Aulas, Alunos, Professores), depois Financeiro, Aulas, Pedagógico, Crescimento e Configurações. Telas parecidas viram abas dentro de uma entrada só. À esquerda, o trilho de atalhos é seu: arraste para lá o que usa todo dia.',
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        view: 'dashboard',
        title: 'Pronto! 🎉',
        text: 'É isso. O que não estiver no menu principal está dentro de uma aba — e "Tour guiado", no menu do seu avatar, traz este passeio de volta quando precisar.',
      },
    ],
  },
];
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        view: 'dashboard',
        title: 'Bom trabalho! 🎉',
        text: 'Qualquer dúvida, "Tour guiado" no menu do seu avatar repete este passeio.',
      },
    ],
  },
];
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        view: 'dashboard',
        title: 'Bons estudos! 🎉',
        text: 'É só isso mesmo. "Tour guiado", no menu do seu avatar, traz este passeio de volta quando quiser.',
      },
    ],
  },
];
