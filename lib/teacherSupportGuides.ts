...
export const TEACHER_SUPPORT_GUIDES: TeacherSupportGuide[] = [
  {
    ...
    steps: [
      'Antecedência: ausência programada (consulta, viagem) avise até 24 h antes; imprevisto, no mínimo 6 h antes. Menos que isso é emergência: avise na hora pelo WhatsApp da escola E ligue para a coordenação — nunca combine só com o aluno.',
      ...
      'A aula coberta sai do seu pagamento e entra no de quem deu. Você e a coordenação recebem o resumo.',
  ...
  },
  {
    id: 'reposicoes',
    title: 'Reposições',
    summary: 'Reposição só existe marcada no sistema: pela tela ou pelo WhatsApp da escola. Remarcar pede motivo; coordenação e família são avisadas.',
    steps: [
      ...
      'Combinou com o aluno? Marque a data e a hora em Reposições — ou mande para o WhatsApp da escola: "Marca a reposição do Theo terça 15h". Sem data ela não aparece para lançar, e é uma aula devida ao aluno.',
      'Mudou? "A reposição do Theo passou para quinta 16:30". Remarcar pede motivo (responda "sim, aluno pediu"). Menos de 3 h antes pode, mas sai destacado para a coordenação — prefira mudar com 24 h.',
      'Não vai mais acontecer? "Desmarca a reposição do Theo" (com o motivo). Em todos os casos a coordenação e a família recebem o aviso na hora, e cada mudança fica no histórico da reposição.',
      'No dia, a reposição aparece em Lançar Aula como REPOSIÇÃO. Passou a data e você não lançou? A escola te cobra uma vez: lance, remarque ou desmarque.',
    ],
    keywords: ['reposição', 'reposicao', 'repor', 'falta', 'remarcar', 'desmarcar', 'marcar'],
    actions: [
      { kind: 'navigate', tab: 'reschedules', label: 'Abrir Reposições' },
      { kind: 'whatsapp-school', text: 'A reposição do(a) <aluno> passou para <dia> <hora>', label: 'Remarcar pelo WhatsApp' },
    ],
  },
  {
    id: 'agenda',
  ...
  },
  {
    ...
    summary: 'Troca de horário fixo você faz pelo WhatsApp da escola; transferência, plano e dúvidas de aluno são com a coordenação.',
    steps: [
      'Aluno mudou o horário fixo? Mande para o WhatsApp da escola: "O aluno Felipe trocou pra 14:30" ou "Ana de segunda 14:00 para quarta 15:00". O bot confirma aula a aula, diz se choca com outra e aplica a partir de amanhã; a coordenação é avisada.',
      'Transferência para outro professor, mudança de plano ou valor: a coordenação registra pelo grupo — mande a mensagem com aluno, dia e horário.',
