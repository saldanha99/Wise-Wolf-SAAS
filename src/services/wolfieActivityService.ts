...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  INVALID_ANSWERS: "Responda todas as perguntas antes de finalizar.",
  QUIZ_NOT_FULLY_ANSWERED: "Confira todas as respostas antes de finalizar.",
  ...
  INVALID_EXPERIENCE_CONTEXT:
    "O universo escolhido ficou inconsistente. Volte e selecione a experiência novamente.",
  AGE_INAPPROPRIATE_EXPERIENCE:
    "Esta experiência não está disponível para este perfil de aluno.",
  AUDIO_TOO_LARGE:
  ...
  ATTEMPT_SAVE_FAILED: "Não conseguimos salvar este feedback. Tente novamente.",
  ...
  WOLFIE_ACTIVITY_FAILED: "O Wolfie encontrou um imprevisto. Tente novamente.",
};
