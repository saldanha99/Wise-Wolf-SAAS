...
Deno.test("DRE report fences one provider POST in durable order", () => {
...
Deno.test("DRE trusts historical markers and resolves tenant integration", () => {
  ...
  assert(source.includes('notificationKind: "DRE_REPORT"'));
});
